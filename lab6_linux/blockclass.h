...
class block {
	...
	int centroid_x,centroid_y,block_xmax,block_xmin,block_ymax,block_ymin,block_r,block_g,block_b,block_size,block_tag;
	//std::vector<int*> block_pixels;

	//block();
	//~block();

	
	bool checkContained(int x,int y);
